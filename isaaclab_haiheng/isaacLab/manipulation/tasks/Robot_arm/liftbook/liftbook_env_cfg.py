...
class CommandsCfg:
    ...
    object_pose = general_mdp.UniformPoseCommandCfg(
        ...
        ranges=general_mdp.UniformPoseCommandCfg.Ranges(
            pos_x=(0.45, 0.55), pos_y=(-0.15, 0.05), pos_z=(0.3, 0.45), roll=(0.0, 0.0), pitch=(0.0, 0.0), yaw=(0.0, 0.0)
        ),
    )
...
class RewardsCfg:
    ...
    object_ee_centering = RewTerm(
        func=mdp.object_ee_centering,
        params={"std": 0.02,"threshold_lift_height":0.06},
        weight=0.8,)
    ...
    object_goal_tracking = RewTerm(
        ...
        params={"std": 0.3, "minimal_height": 0.08, "command_name": "object_pose"},
        weight=30.0,
    )
    ...
    ee_x_parallel_book = RewTerm(
        ...
        params={"std": 0.1,"threshold_dist": 0.03,"threshold_lift_height":0.082},
        weight=2,
    )

    # 引导垂直奖励
    ee_z_perp_book = RewTerm(
        func=mdp.ee_perpendicular_to_vector,
        params={
            "std": 0.1,"threshold_dist": 0.03,"threshold_lift_height":0.082},
        weight=2,
    )
...
@configclass
class LiftBookEnvCfg(ManagerBasedRLEnvCfg):
